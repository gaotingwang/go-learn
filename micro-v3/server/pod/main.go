...
import (
	...
	repository "github.com/gaotingwang/go-learn/micro-v3/server/pod/domain/respository"
	service2 "github.com/gaotingwang/go-learn/micro-v3/server/pod/domain/service"
	"github.com/gaotingwang/go-learn/micro-v3/server/pod/handler"
	"github.com/gaotingwang/go-learn/micro-v3/server/pod/proto/pod"
...
func main() {
	...
	// 6.集群模式下直接拷贝服务端~/.kube/config 文件到本机 ~/.kube/config 中
	//   注意：- config中的域名要能解析正确
	//        - 生产环境可以创建另一个证书
	...
	// 创建k8s连接
	// 在集群外部使用
	// -v /Users/xx/.kube/config:/root/.kube/config
