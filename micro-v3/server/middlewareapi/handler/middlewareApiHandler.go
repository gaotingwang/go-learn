...
import (
	...
	"github.com/gaotingwang/go-learn/micro-v3/server/middlewareapi/plugin/from"
	"github.com/gaotingwang/go-learn/micro-v3/server/middlewareapi/proto/middlewareApi"
	"strconv"
)
...
func (e *MiddlewareApi) AddMiddleware(ctx context.Context, req *middlewareApi.Request, rsp *middlewareApi.Response) error {
	...
	//处理表单
	from.FormToMiddlewareStruct(req.Post, addMiddleInfo)
	//调用后端服务添加数据
