...
import (
	...
	"github.com/gaotingwang/go-learn/micro-v3/server/routeapi/plugin/from"
	"github.com/gaotingwang/go-learn/micro-v3/server/routeapi/proto/routeApi"
...
func (e *RouteApi) AddRoute(ctx context.Context, req *routeApi.Request, rsp *routeApi.Response) error {
	...
	from.FormToSvcStruct(req.Post, addRouteInfo)
