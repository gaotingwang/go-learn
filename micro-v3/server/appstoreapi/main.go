...
import (
	...
	"github.com/gaotingwang/go-learn/micro-v3/server/appstoreapi/handler"
	"github.com/gaotingwang/go-learn/micro-v3/server/appstoreapi/proto/appStoreApi"
...
func main() {
	...
	appStoreService := appStore.NewAppStoreService("go.micro.service.appStore", service.Client())
	// 注册控制器
